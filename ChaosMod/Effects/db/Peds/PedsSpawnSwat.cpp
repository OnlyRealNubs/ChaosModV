...
static const int numOfPeds = 4;

static void OnStart()
{
	static constexpr Hash modelHash = 0x8D8F1B10;
	...
	ADD_RELATIONSHIP_GROUP("_SWAT", &relationshipGroup);
	...
	{
		Ped ped = CreatePoolPed(27, modelHash, playerPos.x, playerPos.y, playerPos.z, 0.f);
		...
		GIVE_WEAPON_TO_PED(ped, GET_HASH_KEY("WEAPON_CARBINERIFLE"), 9999, true, true);
